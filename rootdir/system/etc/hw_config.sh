...
echo 450 > $dev/button-backlight-rgb1/max_current_uA
echo 450 > $dev/button-backlight-rgb2/max_current_uA
echo 1000 > $dev/red/max_current_uA
echo 1000 > $dev/green/max_current_uA
echo 1000 > $dev/blue/max_current_uA
